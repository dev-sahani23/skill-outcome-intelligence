/**
 * seed-districts.ts
 * Seeds all Indian districts (766 districts) into the District table.
 * Run with: npx ts-node prisma/seed-districts.ts
 * Safe to run multiple times (upsert by name+state).
 */
...
const ALL_INDIA_DISTRICTS: { name: string; state: string }[] = [
  // Andaman & Nicobar Islands
  { name: "Nicobar", state: "Andaman & Nicobar Islands" },
  { name: "North & Middle Andaman", state: "Andaman & Nicobar Islands" },
  { name: "South Andaman", state: "Andaman & Nicobar Islands" },
  ...
  { name: "Khairagarh", state: "Chhattisgarh" },
  ...
  { name: "Manendragarh", state: "Chhattisgarh" },
  { name: "Mohla-Manpur", state: "Chhattisgarh" },
  ...
  { name: "Daman", state: "Dadra & Nagar Haveli and Daman & Diu" },
  ...
  { name: "Ramban", state: "Jammu & Kashmir" },
  { name: "Reasi", state: "Jammu & Kashmir" },
  { name: "Samba", state: "Jammu & Kashmir" },
  { name: "Shopian", state: "Jammu & Kashmir" },
  ...
  { name: "Shaheed Bhagat Singh Nagar", state: "Punjab" },
  ...
  { name: "Gangapur City", state: "Rajasthan" },
  ...
  { name: "Jodhpur Rural", state: "Rajasthan" },
  { name: "Karauli", state: "Rajasthan" },
  { name: "Kekri", state: "Rajasthan" },
  ...
  { name: "Sivagangai", state: "Tamil Nadu" },
  ...
  { name: "Komaram Bheem", state: "Telangana" },
